...
import BookBrowser.Config.ConfigInstall as ConfigInstall

####################################################################################################

def setup_logging(application_name='BookBrowser',
    ...
    if 'BookBrowserLogLevel' in os.environ:
        numeric_level = getattr(logging, os.environ['BookBrowserLogLevel'], None)
